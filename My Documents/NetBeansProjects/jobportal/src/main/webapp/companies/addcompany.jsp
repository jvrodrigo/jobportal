...
<head>
    ...
    <title>JobPortal - Añadir empresa</title>
</head>
<body>
...
<div class="content">
    ...
    <main>
        ...
        <s:form action="addCompany" class="com.uva.jobportal.companies.AddCompany">
            <s:textfield name="name" label="Nombre de empresa" />
